...
$(document).ready(function() {
    // AICI TREBUIE SCHIMBAT LINK DACA AVEM FOLDERUL CU ALT NUME
    const pathToAntrenament = "https://localhost/krav_me/pages/antrenament.html";
    let counter = 0;
    ...
    $("#newAntr_submit").on('click',function () {
        $.ajax({
            url: '../php/dbHandler.php',
            method: 'POST',
            data: {
                addAntrenament: 1, // MUST BE ID OF EVENT
                nume: $("#antr_nume").val(),
                locatie: $("#antr_locatie").val(),
                instructor: $("#antr_instructor").val(),
                data: $("#antr_dataStart").val()
            },
            complete: function(response) { // success is not working; using complete as alternative
                // TODO: DO SOMETHING HERE
